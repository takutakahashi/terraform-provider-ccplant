...
func (r *webhookResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"status":           schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "Webhook status."},
			...
			"secret":           schema.StringAttribute{Optional: true, Computed: true, Sensitive: true, MarkdownDescription: "Webhook secret."},
			"signature_header": schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "Header containing the webhook signature."},
			"signature_type":   schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "Signature verification type such as `hmac` or `static`."},
			"signature_prefix": schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "Prefix stripped before signature verification."},
			...
			"max_sessions":   schema.Int64Attribute{Optional: true, Computed: true, MarkdownDescription: "Maximum concurrent sessions created by this webhook."},
...
func webhookGitHubAttribute() schema.SingleNestedAttribute {
	return schema.SingleNestedAttribute{
		...
		Attributes: map[string]schema.Attribute{
			"enterprise_url":       schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "GitHub Enterprise URL."},
...
func webhookTriggerAttributes() map[string]schema.Attribute {
	return map[string]schema.Attribute{
		"id":             schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "Trigger ID. Generated by agentapi-proxy when omitted."},
		"name":           schema.StringAttribute{Required: true, MarkdownDescription: "Trigger name."},
		"priority":       schema.Int64Attribute{Optional: true, Computed: true, MarkdownDescription: "Trigger priority."},
		"enabled":        schema.BoolAttribute{Optional: true, Computed: true, MarkdownDescription: "Whether this trigger is enabled."},
		"conditions":     webhookTriggerConditionsAttribute(),
		"session_config": webhookSessionConfigAttribute(),
		"stop_on_match":  schema.BoolAttribute{Optional: true, Computed: true, MarkdownDescription: "Stop evaluating triggers after this trigger matches."},
	}
}
...
func webhookTriggerConditionsAttribute() schema.SingleNestedAttribute {
	return schema.SingleNestedAttribute{
		...
		Attributes: map[string]schema.Attribute{
			...
			"go_template": schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "Go template expression used as a condition."},
		},
	}
}
...
func webhookGitHubConditionsAttribute() schema.SingleNestedAttribute {
	return schema.SingleNestedAttribute{
		...
		Attributes: map[string]schema.Attribute{
			...
			"draft":         schema.BoolAttribute{Optional: true, Computed: true, MarkdownDescription: "Whether pull request draft state must match."},
...
func webhookSessionConfigAttribute() schema.SingleNestedAttribute {
	return schema.SingleNestedAttribute{
		...
		Attributes: map[string]schema.Attribute{
			...
			"reuse_session":      schema.BoolAttribute{Optional: true, Computed: true, MarkdownDescription: "Reuse matching sessions instead of creating new sessions."},
			"mount_payload":      schema.BoolAttribute{Optional: true, Computed: true, MarkdownDescription: "Mount webhook payload into the session."},
			"session_profile_id": schema.StringAttribute{Optional: true, Computed: true, MarkdownDescription: "Session profile ID used as the base session configuration."},
		},
	}
}
